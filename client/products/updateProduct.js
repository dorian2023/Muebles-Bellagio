...
const getProductByID = async (id) => {
    const productData = await fetch(`https://inventario-mb.onrender.com/api/v1/products?id=${id}`,{
        method: 'GET',
    })
...
const updateAProduct = async (idProduct, changeProduct) => {
    const productData = await fetch(`https://inventario-mb.onrender.com/api/v1/products/${idProduct}`,{
        method: 'PATCH',
        headers:{
